...
class SettingController extends BaseController
{
    ...
    public function store(Request $request) {
        ...
        if ($request->file('intro_video')) {
            $disk = env('DISK_TYPE');
            Storage::disk($disk)->putFileAs('formatted/mainchunks', $request->file('intro_video'), 'decade2.mp4', 'public');
            $intro_video = Helper::uploadFile($request->file('intro_video'), null, Config::get('constants.HOME_PAGE_VIDEO'));
           
        }

        //ORIGINAL -- uncomment under data 
//         $rules = [
...
//            'title.required' => 'Title is required',
    ...
    public function introUpload(Request $request){
