...
<html lang="en">
    <head>
        ...
        @if(Request::url() == 'https://storeetree.com')
            <meta name="title" content="Create Your Story for Family Story for Friends | Video Story Creation Platform - StoreeTree">
            <meta name="description" content="Create and share video stories with StoreeTree! Perfect for family and friends, our platform makes storytelling easy and fun. Create your story and bring your memories to life today.">
        @elseif(Request::url() == 'https://storeetree.com/create-your-story/step-1' || Request::url() == 'https://storeetree.com/create-your-story')
            <meta name="title" content="StoreeTree-Create Your Story For Family and Friends">
            <meta name="description" content="StoreeTree offers an easy-to-use platform to create your story for family and friends. With our life story video maker, you can bring cherished memories to life and share them with loved ones.">
        @elseif(Request::url() == 'https://storeetree.com/about-us')
            <meta name="title" content="About US - Storee Tree">
            <meta name="description" content="Learn about StoreeTree, the ultimate platform for creating and sharing video stories with family and friends. Explore family story ideas and create your own story easily.">
        @elseif(Request::url() == 'https://storeetree.com/faqs')
        <meta name="title" content="StoreeTree - FAQs |  Your Video Story Creation Platform">
        <meta name="description" content="Explore StoreeTree FAQs for answers about our video story creation platform. Learn how to create, share, and personalize stories for family and friends effortlessly.">
        @elseif(Request::url() == 'https://storeetree.com/contact-us')
            <meta name="description" content="Contact Storee Tree for any questions or assistance you may need. Our Contact Us page is your gateway to connecting with our team. Reach out to us today!">
        @elseif(Request::url() == 'https://storeetree.com/blogs/top_5_reasons_why_it%27s_vital_to_recognize_your_heritage')
            <title>StoreeTree - 5 Reasons to Recognize Your Heritage.</title>
            <meta name="title" content="StoreeTree - 5 Reasons to Recognize Your Heritage.">
            <meta name="description" content="Find the importance of recognizing your heritage. Visit StoreeTree for five key reasons and insights on creating your own story, family story ideas, and stories for family and friends.">
        @elseif(Request::url() == 'https://storeetree.com/blogs/4_free_things_to_pass_down_to_your_kids')
            <title>4 Free Things to Pass Down to Your Kids - StoreeTree</title>
            <meta name="title" content="4 Free Things to Pass Down to Your Kids - StoreeTree">
            <meta name="description" content="Learn four meaningful, free things to pass down to your kids. Visit StoreeTree for insights on nurturing family heritage, family story ideas, creating your own story, and stories for family and friends.">
        @elseif(Request::url() == 'https://storeetree.com/blogs/the_importance_of_remembering')
            <title>Importance of Remembering: Insights and Reflections | StoreeTree </title>
            <meta name="title" content="Importance of Remembering: Insights and Reflections | StoreeTree ">
            <meta name="description" content="Find the significance of remembering in our latest blog. Explore insights and reflections on memory's role in shaping our lives. Read more at StoreeTree.">
        @elseif(Request::url() == 'https://storeetree.com/blogs/what_will_you_leave_behind')
            <title>What Will You Leave Behind? | StoreeTree</title>
            <meta name="title" content="What Will You Leave Behind? | StoreeTree ">
            <meta name="description" content="Discover story ideas for family and friends, explore how to make and create your own memorable stories at StoreeTree.">
        @else             
            <meta name="description" content="Transform your memories into unforgettable stories with StoreeTree's video story creation platform. Create, share, and cherish moments with your loved ones, anytime, anywhere.">
        @endif
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('css/frontend/lineage.css') }}"/>
        ...
        @endif
                ...
                <div id="preloader2">
                    ...
                    <div class="loader2_text">
                        ...
                        @elseif(Request::url() == 'https://storeetree.com/create-your-story')
                            <h1>START YOUR STORY NOW </h1>
                        @endif
                    <div class="waviy">
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-2">
                                <div class="ftr_common">
                                    ...
                                    <ul class="social_link">
                                        <li><a href="https://www.facebook.com/people/StoreeTree/61557841971076/"><img src="{{ URL::to('/') }}/images/frontend/social_link_1.png" alt="social_link_1" /></a></li>
                                        <li><a href="https://twitter.com/StoreeTree"><img src="{{ URL::to('/') }}/images/frontend/social_link_2.png" alt="social_link_2" /></a></li>
                                        <li><a href="https://www.instagram.com/storee_tree/"><img src="{{ URL::to('/') }}/images/frontend/social_link_3.png" alt="social_link_3" /></a></li>
                                        <li><a href="https://www.linkedin.com/company/storeetree/"><img src="{{ URL::to('/') }}/images/frontend/social_link_4.png" alt="social_link_4" /></a></li>
                                    </ul>
                                </div><!--ftr_common-->
                            </div>
                        </div>
