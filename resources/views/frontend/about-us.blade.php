...
@section('title')
<title>About US - Storee Tree</title>
@endsection
@section('header')
    <style>
...
<p>She was a unique, spunky, great lady. I remember, every time I saw her I first ask...</p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="block_photo_single" style="margin-bottom: 10px;">
                        <img src="{{ URL::to('/') }}/images/frontend/about_company_2.jpg" alt="about_company_2"/>
            ...
            <div class="row padding_18">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="single_photo_wrapper sd_height2">
                            <div class="block_photo_single" style="margin-bottom: 10px;">
                        		<img src="{{ URL::to('/') }}/images/frontend/about_passion_4.jpg" alt="about_passion_4"/>
                   			 </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="charity_content">
                        ...
                        <img src="{{ asset('images/frontend/bullet.png') }}" alt="bullet" style="float:left; margin-right: 10px;"><h3 class="charity_modal_open">Giving is in our DNA</h3>
                        ...
                        <img src="{{ asset('images/frontend/bullet.png') }}" alt="bullet" style="float:left; margin-right: 10px;"><h3 class="charity_modal_open">Honor Flight Network (HFN)</h3>
                        <img src="{{ asset('images/frontend/bullet.png') }}" alt="bullet" style="float:left; margin-right: 10px;"><h3 class="charity_modal_open">Meals on Wheels America (MWA)</h3>
                        <img src="{{ asset('images/frontend/bullet.png') }}" alt="bullet" style="float:left; margin-right: 10px;"><h3 class="charity_modal_open">American Association of Retired People (AARP)</h3>
                        <img src="{{ asset('images/frontend/bullet.png') }}" alt="bullet" style="float:left; margin-right: 10px;"><h3 class="charity_modal_open">Give Kids the World Village</h3>
                        <span id="dots"></span><span id="more">
                            <p>Heroes Welcome, a subgroup of the HFN, orchestrates an inspiring welcome for these heroes as they get off the plane in DC. In some cases, they can arrange for a similar welcome for their return flight too.  </p>
                            <p>The primary focus of HFN is on veterans with terminal illnesses, especially WWII veterans. As time progresses, the focus will shift to veterans of Korea, then Vietnam, and so on. In the 46 states participating, there are anywhere from one to nine airport “hubs”, where these flights are scheduled.</p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="block_photo_single">
                        <img src="{{ URL::to('/') }}/images/frontend/block_photo.jpg" alt="block_photo"/>
                    </div><!--block_photo_single-->
                </div>
            </div>
        </div>
